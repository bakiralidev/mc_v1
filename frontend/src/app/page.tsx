...
export default function HomePage() {
  ...
  return (
    <main className="relative h-screen w-screen bg-game-dark overflow-hidden font-game select-none">
      ...
      {/* 0. TOP-LEFT: Characters Button */}
      <div className="absolute top-24 left-16 z-30">
        <motion.button
          whileHover={{ scale: 1.05, x: 5 }}
          whileTap={{ scale: 0.95 }}
          onClick={() => router.push('/characters')}
          className="game-panel px-6 py-3 bg-black/60 border-game-gold/30 hover:border-game-gold text-game-gold flex items-center gap-4 group shadow-2xl backdrop-blur-xl"
        >
