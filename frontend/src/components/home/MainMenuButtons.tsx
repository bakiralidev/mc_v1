    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-[12px]">
          <motion.button 
            variants={item}
            className={`game-btn-blue h-[58px] w-full flex items-center justify-center gap-4 group hover:bg-game-blue/20 transition-all border-white/5 -translate-x-24`}
          >
            <User size={22} className="opacity-60 group-hover:opacity-100 group-hover:scale-110 transition-all" />
            <span className="text-[13px] font-black tracking-[0.2em]">PROFILE / STATS</span>
          </motion.button>
          ...
          <motion.button 
            ...
            className={`game-btn-blue h-[58px] w-full flex items-center justify-center gap-4 group hover:bg-game-blue/20 transition-all border-white/5 translate-x-24`}
          >
            <Settings size={22} className="opacity-60 group-hover:opacity-100 group-hover:scale-110 transition-all" />
            <span className="text-[13px] font-black tracking-[0.2em]">SETTINGS</span>
          </motion.button>
        </div>
      </motion.div>
